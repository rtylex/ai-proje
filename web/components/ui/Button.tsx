...
type Props = React.ButtonHTMLAttributes<HTMLButtonElement> & {
  variant?: 'primary' | 'secondary' | 'outline' | 'ghost' | 'corporate' | 'success';
  size?: 'sm' | 'md' | 'lg' | 'xl';
  loading?: boolean;
...
export const Button = React.forwardRef<HTMLButtonElement, Props>(
  ({ 
    ...
    const variants: Record<string, string> = {
      ...
      corporate: 'corporate-gradient text-white hover:shadow-lg focus:ring-primary-500 corporate-button',
